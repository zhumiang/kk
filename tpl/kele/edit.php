...
<div class="menu"> 
<ul>
<li class="onck"><a href="kele.php?model=append&contro=function&view=<?php echo $this->view?>">AddForm</a>&nbsp;<a href="kele.php?model=show&contro=function&view=<?php echo $this->view?>">ShowForm</a></li>
</ul>
</div>
<?php
	$memu=kelefunction::memu($this->view);
?>
	<form name="<?php echo $data['memu']['value']?>" action="kele.php?model=<?php echo $this->model?>&contro=function&view=<?php echo $this->view?>" enctype="multipart/form-data" method="post">
