...
<div class="main">
<div class="login">
<form method=post action='kele.php?contor=login&model=member&view=kele' onSubmit="return notEmpty(username, 'username is Null')&&notEmpty(password, 'password is Null')">
