...
<body>
<?php 
kelemonitor::power('show','workreport');
...
<?php if(keledata::httpval('id')){
	...
	$pname=keledatabase::getthisone(array("sectoral_plan","project_management"),
			array("sectoral_plan.id=".$GLOBALS['DATA']['sectoralplanid'],"sectoral_plan.projectid=project_management.id"),
...
<?php }}?>
        ...
        <a href="<?php echo http_dir?>?model=append&contro=function&view=workreport&wid=<?php echo $value['id']?>">每日工作报告</a>&nbsp;
		<?php }?>
		</td>
      </tr>
      <?php }}?>    
